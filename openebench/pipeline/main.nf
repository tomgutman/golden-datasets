...
// TODO: add validation script to check input files (vcf)
process validation {
	...
	"""
	python /app/validation.py -i $input_file -r $ref_dir -com $community_id -p $tool_name -o $validation_out
	"""

}

// TODO: gather metric scripts for this step
process compute_metrics {
	...
	"""
	python /app/compute_metrics.py -i $input_file -m $gold_standards_dir -p $tool_name -com $community_id -o $assessment_out
	"""

}

// TODO: generate reports in JSON and plots in SVG
